...
import com.psaainsankamil.vitone.adapters.SelectDonaturAdapter;
...
public class SendSelectDonaturActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private SelectDonaturAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_select_data);
    ...
    private void initObjects(){
        ...
        adapter = new SelectDonaturAdapter(listDonatur,this, this);
    ...
    private void select(){
        ...
        List<String> nama_kontak = new ArrayList<>();
        for(int i=0; i<listDonatur.size(); i++){
            if(listDonatur.get(i).getCheck()){
                nama.add(listDonatur.get(i).getNama());
                kontak.add(listDonatur.get(i).getKontak());
                nama_kontak.add(listDonatur.get(i).getKontak()+"("+listDonatur.get(i).getNama()+") ");
            }
        }
        Intent intent = new Intent(this, SendMessageContactActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra("nama", nama.toArray(new String[0]));
        intent.putExtra("kontak", kontak.toArray(new String[0]));
        intent.putExtra("nama_kontak", nama_kontak.toArray(new String[0]));
